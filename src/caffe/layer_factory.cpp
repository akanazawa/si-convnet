...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_PIXEL_ACCURACY:
    return new PixelAccuracyLayer<Dtype>(param);
  ...
  // AJ: transformation invar stuff:
  case LayerParameter_LayerType_UP:
    return new UpsamplingLayer<Dtype>(param);
  case LayerParameter_LayerType_DOWNPOOL:
    return new DownPoolingLayer<Dtype>(param);
  case LayerParameter_LayerType_TIEDCONV:
    return new TiedConvolutionLayer<Dtype>(param);
  case LayerParameter_LayerType_TICONV:
    return new TIConvolutionLayer<Dtype>(param);
  // NIN
