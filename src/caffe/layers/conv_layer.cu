...
void ConvolutionLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  // montage(this->blobs_[0].get(), "tconv" + boost::lexical_cast<std::string>(M_));
  // montage_channels((*top)[0], "output of tconv" + boost::lexical_cast<std::string>(M_));
  // cv::waitKey(0);
}
...
void ConvolutionLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  // montage(top[0], "error for conv " + boost::lexical_cast<std::string>(M_), true);
  // montage(this->blobs_[0].get(), "tconv d/dw" + boost::lexical_cast<std::string>(M_), true);
}
