...
#define INSTANTIATE_CLASS(classname) template class classname<float>;
// Can't have blob of int bc some cuda functions only accept floating point types (pow), etc.
